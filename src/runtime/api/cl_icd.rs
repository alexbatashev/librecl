...
impl _cl_icd_dispatch {
    pub fn new() -> *mut _cl_icd_dispatch {
        Box::leak(Box::new(_cl_icd_dispatch {
            clGetPlatformIDs: Some(crate::api::platform::clGetPlatformIDs),
            clGetPlatformInfo: Some(crate::api::platform::clGetPlatformInfo),
            clGetDeviceIDs: Some(crate::api::device::clGetDeviceIDs),
            clGetDeviceInfo: Some(crate::api::device::clGetDeviceInfo),
            clCreateContext: Some(crate::api::context::clCreateContext),
            clCreateContextFromType: None,
            clRetainContext: None,
            clReleaseContext: None,
            clGetContextInfo: Some(crate::api::context::clGetContextInfo),
            ...
            clCreateBuffer: Some(crate::api::memory::clCreateBuffer),
            ...
            clCreateProgramWithSource: Some(crate::api::program::clCreateProgramWithSource),
            clCreateProgramWithBinary: None,
            clRetainProgram: None,
            clReleaseProgram: None,
            clBuildProgram: Some(crate::api::program::clBuildProgram),
            clUnloadCompiler: None,
            clGetProgramInfo: None,
            clGetProgramBuildInfo: None,
            clCreateKernel: Some(crate::api::kernel::clCreateKernel),
            clCreateKernelsInProgram: None,
            clRetainKernel: None,
            clReleaseKernel: None,
            clSetKernelArg: Some(crate::api::kernel::clSetKernelArg),
            ...
            clFlush: None,
            clFinish: Some(crate::api::queue::clFinish),
            clEnqueueReadBuffer: Some(crate::api::queue::clEnqueueReadBuffer),
            clEnqueueWriteBuffer: Some(crate::api::queue::clEnqueueWriteBuffer),
            ...
            clEnqueueNDRangeKernel: Some(crate::api::queue::clEnqueueNDRangeKernel),
            clEnqueueTask: None,
            ...
            clCreateCommandQueueWithProperties: Some(
                crate::api::queue::clCreateCommandQueueWithProperties,
            ),
            clCreatePipe: None,
            clGetPipeInfo: None,
            clSVMAlloc: None,
