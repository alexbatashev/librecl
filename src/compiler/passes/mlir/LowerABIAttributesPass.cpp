...
// Derived from mlir/lib/Dialect/SPIRV/Transforms/LowerABIAttributesPass.cpp

#include "SPIRVLayoutUtils.h"
...
createGlobalVarForEntryPointArgument(OpBuilder &builder, spirv::FuncOp funcOp,
  ...
  varPointeeType = lcl::VulkanLayoutUtils::decorateType(varPointeeType)
...
class LowerABIAttributesPass final
  ...
  static constexpr ::llvm::StringLiteral getArgumentName() {
    return ::llvm::StringLiteral("lcl-lower-spirv-abi");
  }
  ::llvm::StringRef getArgument() const override {
    return "lcl-lower-spirv-abi";
  }

  ::llvm::StringRef getDescription() const override {
    return "Lower ABI for SPIR-V targets";
  }
...
std::unique_ptr<mlir::Pass> lcl::createLowerABIAttributesPass() {
