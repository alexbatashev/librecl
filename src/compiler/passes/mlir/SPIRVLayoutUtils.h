...
// Derived from mlir/include/mlir/Dialect/SPIRV/Utils/LayoutUtils.h

#ifndef LCL_MLIR_DIALECT_SPIRV_UTILS_LAYOUTUTILS_H_
#define LCL_MLIR_DIALECT_SPIRV_UTILS_LAYOUTUTILS_H_
...
public:
  ...
  static mlir::spirv::StructType
  decorateType(mlir::spirv::StructType structType);
  ...
  static bool isLegalType(mlir::Type type);
...
private:
  ...
  static mlir::Type decorateType(mlir::Type type, Size &size, Size &alignment);

  static mlir::Type decorateType(mlir::VectorType vectorType, Size &size,
                                 Size &alignment);
  static mlir::Type decorateType(mlir::spirv::ArrayType arrayType, Size &size,
                                 Size &alignment);
  static mlir::Type decorateType(mlir::spirv::RuntimeArrayType arrayType,
                                 Size &alignment);
  static mlir::spirv::StructType
  decorateType(mlir::spirv::StructType structType, Size &size, Size &alignment);

  /// Calculates the alignment for the given scalar type.
  static Size getScalarTypeAlignment(mlir::Type scalarType);
};

} // namespace lcl

#endif // LCL_MLIR_DIALECT_SPIRV_UTILS_LAYOUTUTILS_H_
